...
So if the cost of a better abstraction is you spending a few brain cycles specifying it more precisely to your agent, the trade-off is far, far cheaper than it's ever been. This is why I think there's actually less of an excuse for writing low-quality code now than there was before (which sounds crazy in a world where people are lobbing [AI slop grenades](https://noslopgrenade.com/) at each other). Because AI lets you iterate so fast, and because it does a pretty good job of implementing your ideas, it affords you more space to think critically about the systems you're building and the code you're writing.
