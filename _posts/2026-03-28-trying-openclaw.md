...
The capability I'm most interested in next is voice. There are things I genuinely never get to because of the friction of a phone call, e.g. chasing down a quote or following up with a vendor that's only reachable during East Coast business hours (I work West Coast hours). I know that sounds like the worst first-world problem imaginable, but I think it gets at something real about where these tools can actually remove friction from your life rather than just feeling impressive.
