...
Lately a theme has come up in conversation after conversation. Shopify is a very impact-driven culture, which I appreciate, but it also means people are hungry about what goes on their impact reviews. Coming out of a review cycle, everyone is cognizant of the real impact they've driven. So I've been talking with mentees, with colleagues, with new interns, with current CS students, and the question almost always boils down to the same thing: *how do I get myself into a position to have maximal impact, to be utilized, to have a seat at the table, to the point where I can attribute direct outcomes to my work?*
...
Even when I was deep in the code, I was always curious, and some would say precocious, about everything around it, because those things affected my efficacy as an engineer.
...
I'm genuinely curious to revisit this post in a few years and see how the industry has shifted. For now, that's the most straightforward forcing function I've got.
